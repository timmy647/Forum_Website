...
from user_f import user_profile_setname, user_profile_setemail, user_profile_sethandle,\
...
def test_user_profile_sethandle():
	...
	with pytest.raises(ValueError, match=r'Handle must be more than 20 characters'):
		user_profile_sethandle(token,'too_short_string')
